        ...
        <div class="footer-content">
          <div class="footer-brand">
            ...
            <div class="social-links">
              ...
              >
                <svg
                  v-if="link.label?.toLowerCase().includes('facebook')"
                ...
                <svg
                  v-else-if="link.label?.toLowerCase().includes('instagram')"
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
                ...
                <svg
                  v-else-if="link.label?.toLowerCase().includes('youtube')"
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
                ...
                <svg
                  v-else-if="link.label?.toLowerCase().includes('tiktok')"
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
